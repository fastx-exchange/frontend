    ...
    <>
      <header className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <a href="#" >Buy Crypto</a>
          <a href="#" >Market</a>
          <a href="#" id="dropdownDelayButton" data-dropdown-toggle="dropdownDelay" data-dropdown-delay="500" data-dropdown-trigger="hover">Giao dịch</a>
          <a href="#" >Futures</a>
          <a href="#" >Earn</a>
          <a href="#" >Square</a>
          <a href="#" >More</a>
        ...
        <div className={styles.headerRight}>
          ...
          <button type="submit" className={styles.headerButtonLogin}>Login</button>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerColumn} >
          <div className={styles.footerFirstColumn}>
            ...
            <div className={styles.footerIcon}>
              <div className={styles.footerIconTop}>
                <div><DiscordOutlined /></div>
                <div><TikTokOutlined /></div>
                <div><FacebookOutlined /></div>
                <div><RedditOutlined /></div>
              </div>
              <div className={styles.footerIconBottom}>
                <div><DiscordOutlined /></div>
                <div><TikTokOutlined /></div>
                <div><FacebookOutlined /></div>
                <div><RedditOutlined /></div>
          ...
          <div className={styles.footerFourthColumn}>
            <div className={styles.footerFourthColumnBusiness}>
              <b>Business</b>
            ...
            <div className={styles.footerFourthColumnLearn}>
              <b>Learn</b>
          ...
          <div className={styles.footerFifthColumn}>
            <div className={styles.footerFifthColumnService}>
              <b>Service</b>
              <a href="#">Affiliate</a>
              <a href="#">Introduce</a>
            ...
            <div className={styles.footerFifthColumnSupport}>
              <b>Support</b>
